...
<head>
	...
	<title>Follow Up Customer</title>
					...
					<tr>
						<td>
							...
							<table class="table5">
									...
									<tr>
										<td class="td3">Name</td><td><input type="text" name="Name" size="18" placeholder=": Ali" required></td>
									</tr>
									
									<tr><TD></TD></tr><tr><TD></TD></tr>
									
									<tr>
										<td class="td4">Number</td><td><input type="text" name="Notel" size="18" placeholder=": 012 345 6789" required></td>
									</tr>

									<tr><TD></TD></tr><tr><TD></TD></tr>

									<tr>
										<td class="td5">Model</td><td><input type="text" name="Model" size="18" placeholder=": Samsung A30" required></td>
									</tr>
							</table>
							</center>
						</td>
							...
							<table class="table4">
								...
								<tr>
									<td><div class="div7">
										...
										<div><select name="ItemRepair" id="mySelect" style="width: 65%; text-align: center; margin-top: 4%; margin-bottom: 4%; height: 25px;">
											<option value="disabled" disabled selected hidden>-- Select Item --</option>
											...
											<center><textarea type="text" id="otherInput" name="ItemRepairO" style="display: none; font-size: 15px;" cols="17" rows="5" placeholder="*Exp : Camera Replacement"></textarea></center>
					...
					<tr>
						<td><center>
							<table class="table7">
								...
								<tr>
									<td><div class="div8"><center><table class="tableDate"><tr><td><center><p style="font-size: 12px; margin-top: -3%; margin-bottom: -1%; padding-left: 3%; text-align: left;"><b>|&nbsp; *Date (R): Date Repair &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp; *Date (F): Date To Follow-Up</b></p><br>

										Date (R) : &nbsp;<input type="date" name="DateR" id="dateInput" class="inputDate" readonly required ></center></td></tr>	
									...
									<tr><td><center>Date (F) :  &nbsp;&nbsp;<input type="date" name="DateF" id="selectedDate" size="8" class="inputTime" required></center></td></tr></table></center></div></td>

<div>
	<p style="font-size: 12px;"><b>|</b>  *Mb: 1 Month  <b>|</b>  *Bt Android: 2 Week  <b>|</b>  *Bt Ip: 2 Week  <b>|</b>  *Lcd Android: 2 Week  <b>|</b>  *Lcd Ip: 2 Week  <b>|</b></p>
</div>
    ...
    <script>
        ...
        setDateBasedOnOption();
					...
					<div>
						<p align="center" style="margin-top: -4.5%; margin-bottom: 5%; font-size: 13px;">*Need to manual set the <b>Date Follow Up (Date (F))</b> if select <b>Item Repair</b> to <b>Other</b>
					</div>

			</div>

<input type="submit" name="saveReminder" value="SAVE" class="inputBtn"> &nbsp;  &nbsp;  &nbsp; <input type="reset" name="reset" value="RESET" class="inputReset">
