					...
					<tr>
						<td>
							...
							<table class="table5">
									...
									<tr>
										<td class="td3">Name</td><td><input type="text" name="Name" size="18" value="<?php echo $Name; ?>" required></td>
									</tr>
									
									<tr><TD></TD></tr><tr><TD></TD></tr>
									
									<tr>
										<td class="td4">Number</td><td><input type="text" name="Notel" size="18" value="<?php echo $Notel; ?>" required></td>
									</tr>

									<tr><TD></TD></tr><tr><TD></TD></tr>

									<tr>
										<td class="td5">Model</td><td><input type="text" name="Model" size="18" value="<?php echo $Model; ?>" required></td>
									</tr>
							</table>
							</center>
						</td>
								...
								<tr>
									<td><div class="div7">
										...
										<div><select name="ItemRepair" id="mySelect" style="width: 65%; text-align: center; margin-top: 4%; margin-bottom: 4%; height: 25px;" >
											<option selected hidden><?php echo $ItemRepair; ?></option>
											...
											<center><textarea type="text" id="otherInput" name="ItemRepairO" style="font-size: 15px;" cols="17" rows="5" placeholder="*Exp : Camera Replacement"><?php echo $ItemRepairO; ?></textarea></center>
							...
							<table class="table7">
								...
								<tr>
									<td><div class="div8"><center><table class="tableDate"><tr><td><center><p style="font-size: 12px; margin-top: -3%; margin-bottom: -1%; padding-left: 3%; text-align: left;"><b>|&nbsp; *Date (R): Date Repair &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp; *Date (F): Date To Follow-Up</b></p><br>
										...
										Date (R) : &nbsp;<input type="date" name="DateR" id="dateInput" class="inputDate" value="<?php echo($DateR) ?>" required readonly ></center></td></tr>									

									<tr><td><center>Date (F) :  &nbsp;&nbsp;<input type="date" name="DateF" id="selectedDate" size="8" class="inputTime" value="<?php echo($DateF) ?>" required></center></td></tr></table></center></div></td>
...
<input type="submit" name="UpdateReminder" value="SAVE" class="inputBtn"> &nbsp;  &nbsp;  &nbsp; <a href="reminder.php"><button class="inputBtn">BACK</button></a>
