...
while ($GET = mysqli_fetch_array($query)) {
 ...
 ?>
			...
			<div class="div6">
				...
				<table class="table_no" align="left"><tr><td>No:<input type="text"  name="No" size="3" style="font-size: 11px; background-color: #EEEDED; border-color: transparent;" value="<?php echo($No); ?>" readonly></table>
					...
					<table class="table_no" align="left" style="margin-left: 3.5%; margin-top: 4%; margin-bottom: -2%;"><tr><td>Inspection : <select name="Inspec" required>
											<option hidden><?php echo ($Inspec); ?></option>
				...
				<table class="table3">
					<tr>
						<td>
							...
							<table>
									<tr>
										<td class="td3">Name</td><td><input type="text" name="Name" size="13" required value="<?php echo($Name) ?>"></td>
									</tr>
									
									<tr><TD></TD></tr><tr><TD></TD></tr>
									
									<tr>
										<td class="td4">No. Tel</td><td><input type="text" name="Notel" value="<?php echo($Notel) ?>" size="13"  required></td>
									</tr>

									<tr><TD></TD></tr><tr><TD></TD></tr>

									<tr>
										<td class="td5">Model</td><td><input type="text" name="Model" value="<?php echo($Model) ?>" size="13" required></td>
									</tr>
							</table>
							</center>
						</td>
						...
						<td>
							...
							<table class="table4">
								...
								<tr>
									<td><div class="div7">PIN :  &nbsp;&nbsp;<input type="name" name="Pin" size="8" placeholder="123456" required value="<?php echo($Pin) ?>"></div></td>
								</tr>
							</table>
							</center>
						</td>
						...
						<td><center>
							<table class="table6">
								...
								<tr>
									<td><div class="div8"><center><table class="table7"><tr><td>Date  :  &nbsp;&nbsp;&nbsp;<input type="date" name="Date" size="8" class="inputDate" required value="<?php echo($Date) ?>"></td></tr>									

									<tr><td>Time  :  &nbsp;&nbsp;<input type="time" name="Time" size="8" class="inputTime" value="<?php echo($Time) ?>" required></td></tr></table></center></div></td>
...
<tr><td><br></td></tr>
									<tr>
										...
										<td><select name=" Bspeaker">
											<option><?php echo ($Bspeaker); ?></option>
											<option>A</option>
											<option>B</option>
											<option>C</option>
											<option>D</option>
...
<tr><td><br></td></tr>
									...
									<tr>
										...
										<td><select name="Bluetooth">
											<option><?php echo ($Bluetooth); ?></option>
											<option>A</option>
											<option>B</option>
											<option>C</option>
											<option>D</option>
								...
								<table>
									<tr>
										...
										<td><select name="Espeaker">
											<option><?php echo ($Espeaker); ?></option>
											<option>A</option>
											<option>B</option>
											<option>C</option>
											<option>D</option>
...
<tr><td><br></td></tr>
									<tr>
										...
										<td><select name="Bhealth">
											<option><?php echo ($Bhealth); ?></option>
											<option>A</option>
											<option>B</option>
											<option>C</option>
											<option>D</option>
...
<tr><td><br></td></tr>
									<tr>
										...
										<td><select name="Charging">
											<option><?php echo ($Charging); ?></option>
											<option>A</option>
											<option>B</option>
											<option>C</option>
											<option>D</option>
...
<tr><td><br></td></tr>
									...
									<td><select name="Compass">
											<option><?php echo ($Compass); ?></option>
											<option>A</option>
											<option>B</option>
											<option>C</option>
											<option>D</option>
							...
							<td>
								<div>
									<p>Other : <br><textarea rows="6" name="Other"><?php echo ($Other); ?></textarea></p>
...
<input type="submit" name="update" value="SAVE" class="inputBtn">
