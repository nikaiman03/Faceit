 ...
 ?>
			...
			<div class="div6">
				...
				<table class="table_no" align="left"><tr><td>No:<input type="text"  name="No" size="3" style="font-size: 11px; background-color: #EEEDED; border-color: transparent;" value="<?php echo($No); ?>" readonly></table>
					...
					<table class="table_no" align="left" style="margin-left: 3%; margin-top: 3.5%;"><tr><td>Inspection : <select name="Inspec" disabled>
...
<a href="index.php"><button class="inputBtn"> Back </button></a>
		</div>
	</center>
